 ...
 * ==========================================================================
 *
 * Version 3.0.0-beta.10, Fri Oct 16 2020
 *
 * http://dexie.org
 *
...
function Syncable(db) {
    ...
    if (!db.observable || (db.observable.version !== "3.0.0-beta.10" && !/^3\./.test(db.observable.version)))
        throw new Error("Missing dexie-observable version 3.x");
    if (db.syncable) {
        if (db.syncable.version !== "3.0.0-beta.10")
...
Syncable.version = "3.0.0-beta.10";
...
if (Dexie.Syncable) {
    if (Dexie.Syncable.version !== "3.0.0-beta.10") {
        throw new Error("Mixed versions of dexie-syncable");
    }
}
else {
