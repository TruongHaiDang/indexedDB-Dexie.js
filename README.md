...
<img src="./img/7.jpg" alt="..." width="100%" />
    ...
    4) Delete All Xóa toàn bộ dữ liệu<br />
        dữ liệu sau khi xóa sẽ mất hết, Get All sẽ không có gì hiện ra
        để xóa từng dữ liệu thì bấm vào nút delete màu đỏ tương ứng

--------------------------------------------------------------------------------------------------
Chú ý: Nếu mở 2 tab khi ghi dữ liệu ở một tab thì tab còn lại sẽ ghi dữ liệu đó ra ở màn hình console 
